...
// import * as XLSX from 'xlsx'; // Correctly import all named exports from 'xlsx'
...
//         localStorage.setItem('dataEntryData', JSON.stringify(entries));
//         // Clear form or handle other actions
//     };
